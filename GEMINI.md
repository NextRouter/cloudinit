...
Proxmox での Ubuntu の CLoudinit を行うシェルスクリプトを書いてください
**この PC は Mac なので実行は行わないでください**

### VM(vmid:1000,1001,1003,1004,1005)

cpu:2cpu
memory:2GB
Disk:16GB
OS:Ubuntu server(cloudinit)
Username:user
password:user
...
ここまでは同じ設定でいいのですが以下では各 VM の差分のみを記述します

### VM(name:wan0,vmid:1000)
#### vmbr00
LAN:vmbr00
IP:DHCP
DNS:1.1.1.1,1.0.0.1
...
### VM(name:lan0,vmid:1003)
#### vmbr03
LAN:vmbr03
IP:DHCP

### VM(name:lan1,vmid:1004)
#### vmbr03
LAN:vmbr03
IP:DHCP

### VM(name:lan1,vmid:1005)
#### vmbr03
LAN:vmbr03
IP:DHCP
