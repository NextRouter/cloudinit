...
qm set 1000 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.100/24
...
qm set 1001 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.101/24
qm set 1001 --nameserver "1.1.1.1 1.0.0.1"

# VM 1003: lan0
create_vm 1003 "lan0" ${COMMON_CORES} ${COMMON_MEMORY} ${COMMON_DISK}
qm set 1003 --net0 virtio,bridge=vmbr12 --ipconfig0 ip=dhcp
qm set 1003 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.103/24

# VM 1004: lan1
create_vm 1004 "lan1" ${COMMON_CORES} ${COMMON_MEMORY} ${COMMON_DISK}
qm set 1004 --net0 virtio,bridge=vmbr12 --ipconfig0 ip=dhcp
qm set 1004 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.104/24

# VM 1005: lan2
create_vm 1005 "lan2" ${COMMON_CORES} ${COMMON_MEMORY} ${COMMON_DISK}
qm set 1005 --net0 virtio,bridge=vmbr12 --ipconfig0 ip=dhcp
qm set 1005 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.105/24
...
qm set 1002 --net2 virtio,bridge=vmbr12 --ipconfig2 ip=172.0.12.1/24
qm set 1002 --net100 virtio,bridge=vmbrvmbr000 --ipconfig1 ip=172.0.0.102/24
